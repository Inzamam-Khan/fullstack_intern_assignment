...
var loginUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, user, dbRes, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 4, , 5]);
                return [4 /*yield*/, client_1.default.user.findUnique({ where: { email: email } })];
            case 2:
                user = _b.sent();
...
var signupUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, findUser, saltRounds, newUser, _b, _c;
    var _d, _e;
    return __generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 1:
                findUser = _f.sent();
                if (findUser) {
                    return [2 /*return*/, res.status(500).json({ message: "Email Already Exists!" })];
                }
                saltRounds = 10;
                _c = (_b = client_1.default.user).create;
                _d = {};
                _e = {
                    email: email
                };
